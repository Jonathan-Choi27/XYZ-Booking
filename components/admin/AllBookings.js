...
import { downloadInvoice } from "../../backend/utils/downloadInvoice";
  ...
  const setBookings = () => {
    ...
    bookings &&
      bookings.forEach((booking) => {
        data.rows.push({
          id: booking._id,
          checkIn: new Date(booking.checkInDate).toLocaleString("en-AU"),
          checkOut: new Date(booking.checkOutDate).toLocaleString("en-AU"),
